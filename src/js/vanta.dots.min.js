      ...
      class n extends s.b {
        ...
        onInit() {
          ...
          var e,
            ...
            h,
            a,
            c = (this.starsGeometry = new THREE.Geometry()),
            u = this.options.spacing;
          for (e = s = -30; s <= 30; e = ++s)
            for (i = n = -30; n <= 30; i = ++n)
              ((r = new THREE.Vector3()).x = e * u + u / 2),
                (r.y = Object(o.h)(0, 5) - 150),
                (r.z = i * u + u / 2),
                c.vertices.push(r);
          (h = new THREE.PointsMaterial({
            ...
            (a = this.starField = new THREE.Points(c, h)),
            this.scene.add(a);
          ...
          for (e = 0; e < 200; e++) {
            var p = Object(o.h)(40, 60),
              ...
              v = Math.sin(g) * w,
              y = Math.cos(g) * w;
            d.vertices.push(new THREE.Vector3(y * p, v * p, m * p)),
              d.vertices.push(new THREE.Vector3(y * f, v * f, m * f));
          }
          (this.linesMesh = new THREE.LineSegments(d, l)),
        ...
        onUpdate() {
          ...
          const s = this.camera;
          (s.position.x += 0.003 * (s.tx - s.position.x)),
            (s.position.y += 0.003 * (s.ty - s.position.y)),
            (s.position.z += 0.003 * (s.tz - s.position.z)),
            s.lookAt(0, 0, 0),
